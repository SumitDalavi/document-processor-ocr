...
Scalable OCR document processing service that extracts text and layout information from PDFs and images.
...
- **Throughput/Latency:** Pipeline state transitions < 5ms
...
- Malicious file uploads (Zip bombs, etc).
...
- **Mocked / Demo Mode:** The actual ML Vision OCR inference is stubbed to return deterministic parsed text for fast CI execution.
